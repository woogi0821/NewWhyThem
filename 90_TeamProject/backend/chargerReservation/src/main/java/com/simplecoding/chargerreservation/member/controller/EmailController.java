...
public class EmailController {
    ...
    // 인증번호 발송 API
    @PostMapping("/send")
    public ResponseEntity<String> sendEmail(@Valid @RequestBody EmailVerificationDto.Send request) {
    ...
    // 인증번호 확인 API
    @PostMapping("/verify")
    public ResponseEntity<String> verifyCode(@Valid @RequestBody EmailVerificationDto.Verify request) {
